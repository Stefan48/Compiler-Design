...
import cool.tree.ASTConstructionVisitor;
import cool.tree.ASTFirstSemanticVisitor;
import cool.tree.ASTSecondSemanticVisitor;
import cool.tree.ASTThirdSemanticVisitor;
...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ast.accept(new ASTFirstSemanticVisitor());
        ast.accept(new ASTSecondSemanticVisitor());
        ast.accept(new ASTThirdSemanticVisitor());
